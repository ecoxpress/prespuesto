...
var newRow = '<tr><td><a class="control removeRow" href="#">x</a><span contenteditable>00001</span></td><td><span contenteditable>Descripción</span></td><td class="amount"><input type="text" value="1"/></td><td class="rate"><input type="text" value="99" /></td><td class="tax taxrelated"></td><td class="sum"></td></tr>';
